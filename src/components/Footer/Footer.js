      ...
      <div className="max-w-screen-xl w-full mx-auto">
          ...
          <div className="flex items-center space-x-4 md:space-x-6">
            ...
            <div className="md:w-6 w-5  my-auto">
              <Image
                ...
                alt="linkedin"
                onClick={() => {
                  router.push("https://www.linkedin.com/in/iranjansharma");
                }}
              />
            </div>
            <div className="md:w-6 w-5 my-auto">
              <Image
                ...
                className="cursor-pointer"
                alt="github"
                onClick={() => router.push("https://github.com/sharma3ranjan")}
              />
            </div>
          </div>
        </div>
        <p className="mt-6 text-gray-200 text-center flex items-center flex-wrap justify-center">
          ...
          <span className="text-white hover:underline ml-2">
            <Link href="https://ranjansharma.tech">Ranjan Sharma</Link>
          </span>
        </p>
      </div>
    </div>
