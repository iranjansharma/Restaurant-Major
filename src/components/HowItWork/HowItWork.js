        ...
        <div className="mt-20">
          <div className="flex sm:justify-evenly text-center sm:gap-4 gap-8 flex-wrap sm:flex-row flex-col">
            <div className="flex flex-col items-center sm:gap-6 gap-4">
              <CursorClickIcon className="sm:w-14 w-10 text-green-600 mx-auto" />
            ...
            <div className="flex flex-col items-center sm:gap-6 gap-4">
              <CreditCardIcon className="sm:w-14 w-10 text-green-600 mx-auto" />
            ...
            <div className="flex flex-col items-center sm:gap-6 gap-4">
              <TruckIcon className="sm:w-14 w-10 text-green-600 mx-auto" />
